            ...
            <div className="list-group list-group-flush" style={{ maxHeight: "70vh", overflowY: "auto" }}>
              {users.map((u) => (
                <button
                  key={u._id}
                  type="button"
                  className={`list-group-item list-group-item-action ${currentChat === u.username ? "active" : ""}`}
        ...
        <div className="col-12 col-md-8 col-lg-9">
          {currentChat ? (
            <div className="card shadow-sm h-100">
              ...
              <div className="card-body d-flex flex-column" style={{ height: "60vh", overflowY: "auto" }}>
                <MessageList messages={messages} user={user} />
                {isTyping && <div className="text-muted small mt-2">{currentChat} is typing...</div>}
              </div>
